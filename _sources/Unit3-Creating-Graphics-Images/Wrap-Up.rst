...
.. raw:: html
    ...
    <p>
    <p>For this unit, there are three sets of coding drills linked to the Wrap-up Unit on the student-facing site.  These can be assigned as additional exercises to help improve coding knowledge and skills.  Solutions are linked only to the teacher-facing site.  
    </p><ul>
